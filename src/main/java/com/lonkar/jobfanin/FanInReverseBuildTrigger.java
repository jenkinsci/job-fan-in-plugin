...
public final class FanInReverseBuildTrigger extends Trigger<Job> implements DependencyDeclarer {
	...
	private final boolean dontTraceUpstreamProjects;
	private final Result threshold;
	private ArrayList<Job> upsteamProjects;
	private DependencyGraph dependencyGraph;

	@DataBoundConstructor
	public FanInReverseBuildTrigger(String upstreamProjects, boolean traceUpstreamProjects, Result threshold) {
		this.upstreamProjects = upstreamProjects;
		this.dontTraceUpstreamProjects = traceUpstreamProjects;
